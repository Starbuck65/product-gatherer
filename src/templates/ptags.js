...
const ptag = {
  ...
  A5_4tags : (product, discountPrice, normalPrice, start, end) => {
  ...
  A5_3tags : (product, discountPrice, normalPrice, start, end) => {
    var doc = new jsPDF('l','mm','A4');
    doc.addFont('Verdana.ttf', 'Verdana', 'normal','WinAnsiEncoding');
    doc.addFont('Verdana Bold.ttf', 'Verdana', 'bold','WinAnsiEncoding');
    doc.addFont('Verdana Bold Italic.ttf', 'Verdana', 'bold italic','WinAnsiEncoding');
  ...
  A5_2tags : (product, discountPrice, normalPrice, start, end) => {
    var doc = new jsPDF('l','mm','A4');
    doc.addFont('Verdana.ttf', 'Verdana', 'normal','WinAnsiEncoding');
    doc.addFont('Verdana Bold.ttf', 'Verdana', 'bold','WinAnsiEncoding');
    doc.addFont('Verdana Bold Italic.ttf', 'Verdana', 'bold italic','WinAnsiEncoding');
  ...
  A5_1tags : (product, discountPrice, normalPrice, start, end) => {
    var doc = new jsPDF('l','mm','A4');
    doc.addFont('Verdana.ttf', 'Verdana', 'normal','WinAnsiEncoding');
    doc.addFont('Verdana Bold.ttf', 'Verdana', 'bold','WinAnsiEncoding');
    doc.addFont('Verdana Bold Italic.ttf', 'Verdana', 'bold italic','WinAnsiEncoding');
  ...
  pb25x60_2tags: (product, discountPrice, normalPrice, start, end) => {
  ...
  pb25x60_1tag: (product, discountPrice, normalPrice, start, end) => {
    var doc = new jsPDF('p','mm',[500,600]);
    doc.addFont('Verdana.ttf', 'Verdana', 'normal','WinAnsiEncoding');
    doc.addFont('Verdana Bold.ttf', 'Verdana', 'bold','WinAnsiEncoding');
    doc.addFont('Verdana Bold Italic.ttf', 'Verdana', 'bold italic','WinAnsiEncoding');
